      ...
      <Paper shadow="md" radius="md" p="xl" withBorder>
        <Stack spacing="lg">
          ...
          <Alert icon={<IconInfoCircle size={16} />} color="blue" title="About language settings">
            Set your default language preferences for cover letter generation and other multilingual features.
            You can always change the language when generating specific content.
          </Alert>
          ...
          <Stack spacing="md">
            ...
            <Text size="sm" color="dimmed">
              ...
              Individual cover letter generation will still allow you to select a different language.
            </Text>
          </Stack>
